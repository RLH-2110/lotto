...
expectedArgsC = 1 + 1 +50 + 12 # progamm name + number total games + 50 numbers + 12 numbers

if len(sys.argv) != expectedArgsC and len(sys.argv) != expectedArgsC + 1 and len(sys.argv) != 2 and len(sys.argv) != 3:
	print("Usage: "+str(sys.argv[0]) + " [total games] [amount number 1] [amount number 2] ... [amount number 50] [amount extra number 1] [amount extra number 2] .. [amount extra number 12] (optional output filename)")
...
freq[40],freq[41],freq[42],freq[43],freq[44],freq[45],freq[46],freq[47],freq[48],freq[49],\
\
freq[50],freq[51],freq[52],freq[53],freq[54],freq[55],freq[56],freq[57],freq[58],freq[59],\
freq[60],freq[61])
